 ...
 */
final class Version20240319154927 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE homemade_recipe (id INT AUTO_INCREMENT NOT NULL, recipe_name VARCHAR(150) NOT NULL, hair_type VARCHAR(150) NOT NULL, effect_hair VARCHAR(150) NOT NULL, preparation VARCHAR(50000) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
